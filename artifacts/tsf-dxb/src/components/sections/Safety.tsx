    ...
    <section id="safety" className="py-28 bg-white dark:bg-background relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-display font-black text-foreground mt-3 mb-6">{t.rules_title}</h2>
          <p className="text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">{t.rules_sub}</p>
        </motion.div>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-5 shrink-0">
                  <span className="text-4xl font-display font-black text-border/60 group-hover:text-primary/20 transition-colors leading-none mt-1">{rule.number}</span>
        ...
        >
          <p className="text-muted-foreground text-lg italic">{t.rules_quote}</p>
        </motion.div>
      </div>
    </section>
  );
