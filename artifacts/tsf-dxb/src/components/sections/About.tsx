...
const PILLARS = [
  {
    emoji: "🌊",
    title: "Community",
    desc: "A welcoming tribe of water lovers — all backgrounds, all abilities"
  },
  {
    emoji: "🛡️",
    title: "Safety",
    desc: "Every session starts with a safety briefing led by qualified coaches"
  },
  {
    emoji: "💚",
    title: "100% Free",
    desc: "No fees, no memberships, no hidden costs — ever. The water belongs to everyone"
  }
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-6">
            We are Dubai's passionate, community-driven club of stand-up paddlers and kayakers.
            Founded on a simple belief: water sports should be accessible to{" "}
            <strong className="text-foreground font-semibold">absolutely everyone</strong>,
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            ...
            charges absolutely nothing to join. We are a volunteer-run community that grows through word of mouth, shared passion, and good energy on the water. Come paddle with us — you belong here.
          </p>

          <div className="mt-8 inline-flex items-center gap-3 px-6 py-3 rounded-full bg-secondary/10 border border-secondary/20 text-secondary font-bold text-lg">
            <Heart className="w-5 h-5 fill-secondary" />
            Zero cost. Zero barriers. Just paddle.
          </div>
        </motion.div>
